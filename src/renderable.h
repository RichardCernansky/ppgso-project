...
public:
    ...
    /// Update the object. Useful for specifying animation and behavior.
    ...
    virtual bool update_child(float d, Scene &scene, glm::mat4 parentModelMatrix) {
        return false;
    }
    ...
    virtual const std::vector<std::unique_ptr<Renderable>> &getChildren() const {
        return children;
    }
};
